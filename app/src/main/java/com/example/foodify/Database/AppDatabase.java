 ...
 */
@Database(entities = {UserEntity.class, ShoppingListEntity.class, ProductOnListEntity.class, ProductEntity.class, PointEntity.class, PromotionEntity.class, CommentEntity.class}, version = 3)
