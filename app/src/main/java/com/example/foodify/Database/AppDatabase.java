 ...
 */
@Database(entities = {UserEntity.class, ShoppingListEntity.class, ProductOnListEntity.class, ProductEntity.class, PointEntity.class, PromotionEntity.class, CommentEntity.class, ProductInShopEntity.class}, version = 3)
